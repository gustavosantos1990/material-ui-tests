                                ...
                                <Link href="/enterprise" style={link}>
                                    <Card style={card}>
                                        <Box display="flex" p={2}>
                                            ...
                                            <Box p={1}>
                                                <Typography gutterBottom variant="h6">Enterprises</Typography>
                                            </Box>
                                        </Box>
                                    </Card>
                                </Link>
                                ...
                                <Link href="/other" style={link}>
                                    <Card style={card}>
                                        <Box display="flex" p={2}>
                                            ...
                                            <Box p={1}>
                                                <Typography gutterBottom variant="h6">Sales</Typography>
                                            </Box>
                                        </Box>
                                    </Card>
                                </Link>
                                ...
                                <Link href="/other" style={link}>
                                    <Card style={card}>
                                        <Box display="flex" p={2}>
                                            ...
                                            <Box p={1}>
                                                <Typography gutterBottom variant="h6">Statistics</Typography>
                                            </Box>
                                        </Box>
                                    </Card>
                                </Link>
